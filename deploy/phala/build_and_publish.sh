...
#
# Builds the three measured OCI images (one per enclave role: mail, web, hook)
...
# Three images now, one per enclave role, each carrying only its reachable code.
