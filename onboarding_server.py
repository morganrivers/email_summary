...
OAUTH_HELPER = SCRIPT_DIR / "oauth_helper.mjs"
...
def provision(code):
    ...
    try:
        ...
        email = profile["email"]
        creds_rel = os.path.join("accounts", email, ".gmail-mcp")
        creds_abs = account.SCRIPT_DIR / creds_rel
    ...
    acct = account.register_account(email, profile["first"], profile["last"], creds_rel)
